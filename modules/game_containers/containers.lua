...
function refreshContainerItems(container)
    for slot = 0, container:getCapacity() - 1 do
        ...
        if rarity then
            ...
            if lowerRarity:find("legendary") then
                itemWidget:setImageSource("/images/ui/rarity_gold.png")
            elseif lowerRarity:find("epic") then
                itemWidget:setImageSource("/images/ui/rarity_purple.png")
            elseif lowerRarity:find("rare") then
                itemWidget:setImageSource("/images/ui/rarity_blue.png")
            elseif lowerRarity:find("mythic") then
                itemWidget:setImageSource("/images/ui/rarity_mythic.png")
            end
        else
